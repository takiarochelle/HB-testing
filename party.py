...
def is_mel(name, email):
    ...
    >>> is_mel('Jane Doe', 'jane@somecompany.com')
    False

    >>> is_mel('Mel Melitpolski', 'mel@melons.com')
    True

    >>> is_mel('Takia Rudolph', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type':'dessert'}, {'type':'drink'}, {'type':'snack'}, {'type': 'dessert'}, {'type':'drink'}])
    ('dessert', 'snack')

    >>> most_and_least_common_type([{'type':'dessert'}, {'type':'dessert'}, {'type':'dessert'}])
    ('dessert', 'dessert')

    >>> most_and_least_common_type([{'type':'snack'}, {'type':'drink'}, {'type':'snack'}, {'type':'dessert'}, {'type':'drink'}])
    ('snack', 'dessert')
